            ...
            <div class="content_top">
                <div class="col-md-8 col1">
                    <a href="#" class="b-link-stroke b-animate-go  thickbox">
                        ...
                        <div class="b-wrapper2"><h2 class="b-animate b-from-left    b-delay03 ">Photo 1</h2>

                            <p class="b-animate b-from-right    b-delay03 ">Lorem ipsum dolor sit amet, consectetur
                ...
                <div class="col-md-4">
                    <a href="#" class="b-link-stroke b-animate-go  thickbox">
                        ...
                        <div class="b-wrapper1"><h2 class="b-animate b-from-left    b-delay03 ">Photo 1</h2>
            ...
            <div class="content_middle">
                <div class="col-md-4 col2">
                    <a href="#" class="b-link-stroke b-animate-go  thickbox">
                        ...
                        <div class="b-wrapper"><h2 class="b-animate b-from-left    b-delay03 ">Photo 1</h2>
                ...
                <ul class="lb-album">
                    ...
                    <li>
                        ...
                        <div class="lb-overlay" id="image-2">
                            ...
                            <div>
                                <h3>port de bras <span>/ËŚpĂ´r dÉ™ ËbrĂ¤/</span></h3>
                    ...
                    <li>
                        ...
                        <div class="lb-overlay" id="image-3">
                            ...
                            <div>
                                <h3>pliÂ·Ă© <span>/plÄ“ËÄ/</span></h3>
                    ...
                    <li>
                        ...
                        <div class="lb-overlay" id="image-4">
                            ...
                            <div>
                                <h3>aÂ·daÂ·gio <span>/É™ËdĂ¤jĹŤ/</span></h3>
                    ...
                    <li>
                        ...
                        <div class="lb-overlay" id="image-5">
                            ...
                            <div>
                                <h3>frapÂ·pĂ©<span>/fraËpÄ/</span></h3>

                                <p>Involving a beating action of the toe of one foot against the ankle of the supporting
                                    leg</p>
                            </div>
                            <a href="#page" class="lb-close">x Close</a>
                        </div>
                    ...
                    <li>
                        ...
                        <div class="lb-overlay" id="image-6">
                            ...
                            <div>
                                <h3>glisÂ·sade <span>/gliËsĂ¤d/</span></h3>

                                <p>One leg is brushed outward from the body, which then takes the weight while the
                                    second leg is brushed in to meet it</p>
                            </div>
                            <a href="#page" class="lb-close">x Close</a>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="lb-overlay" id="image-7">
                            ...
                            <div>
                                <h3>jeÂ·tĂ© <span>/zhÉ™-ËtÄ/</span></h3>
                    ...
                    <li>
                        ...
                        <div class="lb-overlay" id="image-8">
                            ...
                            <div>
                                <h3>piÂ·quĂ© <span>/pÄ“ËkÄ/</span></h3>

                                <p>Strongly pointed toe of the lifted and extended leg sharply lowers to hit the floor
                                    then immediately rebounds upward</p>
                            </div>
                            <a href="#page" class="lb-close">x Close</a>
                        </div>
                    </li>
